...
import { Type16, type16Schema } from './type16.js';
...
export const paymentsFundsTransferSchema: Schema<PaymentsFundsTransfer> = typedExpandoObject(
  {
    type: ['type', type16Schema],
    purpose: ['purpose', optional(purposeSchema)],
    recipient: [
      'recipient',
