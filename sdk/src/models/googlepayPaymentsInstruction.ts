...
export interface GooglepayPaymentsInstruction extends PaymentsInstruction {

}

export const googlepayPaymentsInstructionSchema: Schema<GooglepayPaymentsInstruction> = typedExpandoObject(
  {
    paymentInstrument: [
      'paymentInstrument',
