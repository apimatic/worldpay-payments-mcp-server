...
import { IssuerResponse, issuerResponseSchema } from './issuerResponse.js';
import { Outcome7, outcome7Schema } from './outcome7.js';
...
export const verificationSchema: Schema<Verification> = typedExpandoObject(
  {
    outcome: ['outcome', optional(outcome7Schema)],
    issuerResponse: ['issuerResponse', optional(issuerResponseSchema)],
