...
|  --- | --- | --- | --- |
| `outcome` | [`Outcome7Enum \| undefined`](../../doc/models/outcome-7-enum.md) | Optional | If the request was authenticated successfully or an authentication outage exemption was applied in authorization. See details on [Authentication Outage](/products/payments/enable-features/3ds-authentication#how-to-enable-authentication-outage-exemptions)<br><br>**Default**: `Outcome7Enum.Authenticated` |
| `issuerResponse` | [`IssuerResponseEnum \| undefined`](../../doc/models/issuer-response-enum.md) | Optional | If the issuer decides to challenge the customer or proceed (frictionless) |
