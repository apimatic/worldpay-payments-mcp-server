...
| `browserColorDepth` | [`BrowserColorDepthEnum \| undefined`](../../doc/models/browser-color-depth-enum.md) | Optional | The color depth of your customers browser |
...
| `channel` | [`ChannelEnum \| undefined`](../../doc/models/channel-enum.md) | Optional | Determines the channel that the transaction came through. `native` should only be set if using the Cardinal 3DS SDK (iOS/Android) |
